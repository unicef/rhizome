...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SourceIndicator.mapped_status'
        db.add_column(u'meta_map_sourceindicator', 'mapped_status',
                      self.gf('django.db.models.fields.CharField')(default='TO_MAP', max_length=55),
                      keep_default=False)

        # Adding field 'SourceRegion.mapped_status'
        db.add_column(u'meta_map_sourceregion', 'mapped_status',
                      self.gf('django.db.models.fields.CharField')(default='TO_MAP', max_length=55),
                      keep_default=False)
        ...
        # Adding field 'SourceCampaign.mapped_status'
        db.add_column(u'meta_map_sourcecampaign', 'mapped_status',
                      self.gf('django.db.models.fields.CharField')(default='TO_MAP', max_length=55),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SourceIndicator.mapped_status'
        db.delete_column(u'meta_map_sourceindicator', 'mapped_status')

        # Deleting field 'SourceRegion.mapped_status'
        db.delete_column(u'meta_map_sourceregion', 'mapped_status')
        ...
        # Deleting field 'SourceCampaign.mapped_status'
        db.delete_column(u'meta_map_sourcecampaign', 'mapped_status')
