...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegionMap.source_region'
        db.alter_column(u'meta_map_regionmap', 'source_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meta_map.SourceRegion']))

        # Changing field 'RegionMap.master_region'
        db.alter_column(u'meta_map_regionmap', 'master_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region']))

        # Changing field 'CampaignMap.master_campaign'
        db.alter_column(u'meta_map_campaignmap', 'master_campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Campaign']))

        # Changing field 'CampaignMap.source_campaign'
        db.alter_column(u'meta_map_campaignmap', 'source_campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meta_map.SourceCampaign']))

    def backwards(self, orm):

        # Changing field 'RegionMap.source_region'
        db.alter_column(u'meta_map_regionmap', 'source_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meta_map.SourceIndicator']))

        # Changing field 'RegionMap.master_region'
        db.alter_column(u'meta_map_regionmap', 'master_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Indicator']))

        # Changing field 'CampaignMap.master_campaign'
        db.alter_column(u'meta_map_campaignmap', 'master_campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Indicator']))

        # Changing field 'CampaignMap.source_campaign'
        db.alter_column(u'meta_map_campaignmap', 'source_campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meta_map.SourceIndicator']))
