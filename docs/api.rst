...
.. code-block:: python
   :linenos:
    ...
    http://polio.seedscientific.com/api/v1/indicator/format=json&indicator_slug=pct-of-children-missed-due-to-child-not-available
...
.. code-block:: python
   :linenos:
    ...
    http://polio.seedscientific.com/api/v1/indicator/format=json&indicator=11
...
.. code-block:: python
   :linenos:
    ...
    http://polio.seedscientific.com/api/v1/datapoint/?format=json&region_slug=kandahar-city&indicator_slug=number-of-children-missed-due-to-refusal-to-accept-opv
...
.. code-block:: python
   :linenos:
    ...
    ENDPOINT = 'http://polio.seedscientific.com/api/v1/datapoint/'
    USERNAME = 'john'
    ...
    def test_datapoint_POST():
        ...
        data = '{"indicator": "this-is-a-test" \
        ,"campaign": "nigeria-2013-01" \
        ,"region": "khakrez" \
        ,"value": "1.077"}'
...
.. autoclass:: datapoints.api.simple
   :members:
