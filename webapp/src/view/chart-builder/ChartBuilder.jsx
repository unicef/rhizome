	...
	render: function(){
     ...
     var rightPage = (<div className="right-page">
     	              	...
     	              	<div className="grouping">
     	                   ...
     	                   <RadioGroup name="show" horizontal={true}  value={this.state.store.locationRadioValue} values={this.state.store.locationRadios} onChange={ChartBuilderActions.selectShowLocationRadio} />
                        </div>
                        <div className="grouping">
