/**
 * Created by sczhang on 12/16/15.
 */
import React from 'react'
import HomepageCharts from 'view/pdf-test/PdfCharts.jsx'

var PdfChartBlock = React.createClass({
  propTypes: {
  ...
  render: function () {
    ...
    return (
      <div>
        <div className='pdf-chart columns chart-container' id={chartId}>
          <div className='chart'>
