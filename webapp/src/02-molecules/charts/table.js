...
// this function checking the value of the table cell, if it was a floating number
// just making a roundof
 function makeCellValue(n) {

      if( n.toString().match(/^-?\d*(\.\d+)?$/) && !isNaN(parseFloat(n)) && (n%1!=0) ){
       //console.log("format Decimal ", d3.format(".2f")(n));
...
_.extend(TableChart.prototype, {
  ...
  update: function (data, options) {
    ...
    var z = 50 //  extra margin space needed to add the "z" (parent) axis"
    ...
    cg.append('text')
          ...
          .text(function (d) { return makeCellValue(d.displayValue) })
          .transition()
          .duration(500)
