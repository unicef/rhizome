...
var IndicatorAdmin = React.createClass({
	...
	componentDidMount: function() {
		...
		API.admin.indicators().done(response => {
			this.setState({indicators: response.objects});
		});
	},
	...
	render: function() {
		var isLoaded = _.isArray(this.state.indicators) && this.state.schema && this.state.schema.items;
