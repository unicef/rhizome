...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Region.full_name'
        db.alter_column('region', 'full_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=55))

        # Changing field 'Region.slug'
        db.alter_column('region', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=55, populate_from='short_name'))

        # Changing field 'Indicator.slug'
        db.alter_column('indicator', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=55, populate_from='name', unique_with=()))

    def backwards(self, orm):

        # Changing field 'Region.full_name'
        db.alter_column('region', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))

        # Changing field 'Region.slug'
        db.alter_column('region', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from='short_name'))

        # Changing field 'Indicator.slug'
        db.alter_column('indicator', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), unique=True, populate_from='name'))
    ...
    models = {
        ...
        u'datapoints.region': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '55', 'populate_from': "'short_name'"})
        },
