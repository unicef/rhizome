...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AggregationExpectedData.slug'
        db.add_column('aggregation_expected_data', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default=2, unique=False, max_length=55, populate_from=('aggregation_type', 'content_type'), unique_with=()),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AggregationExpectedData.slug'
        db.delete_column('aggregation_expected_data', 'slug')
