...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('datapoint', 'reporting_period_id', 'campaign_id')
        sql = db.foreign_key_sql('datapoint', 'campaign_id', 'campaign', 'id')
        db.execute(sql)

    def backwards(self, orm):
        # Rename 'full_name' field to 'name'
        db.rename_column('datapoint', 'campaign_id', 'reporting_period_id')
        db.delete_foreign_key('datapoint', 'campaign_id')
