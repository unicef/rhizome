...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('region', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='z', unique_with=(), max_length=50, populate_from='short_name'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Region.slug'
        db.delete_column('region', 'slug')
