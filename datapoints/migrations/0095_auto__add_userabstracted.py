...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserAbstracted'
        db.create_table('user_abstracted', (
            ...
            ('last_name', self.gf('django.db.models.fields.BooleanField')()),
            ('group_json', self.gf('jsonfield.fields.JSONField')()),
            ('region_permission_json', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal(u'datapoints', ['UserAbstracted'])


    def backwards(self, orm):
        # Deleting model 'UserAbstracted'
        db.delete_table('user_abstracted')
