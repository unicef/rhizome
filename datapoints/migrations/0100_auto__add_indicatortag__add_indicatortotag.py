...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndicatorTag'
        db.create_table('indicator_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('parent_tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.IndicatorTag'], null=True)),
        ))
        db.send_create_signal(u'datapoints', ['IndicatorTag'])

        # Adding model 'IndicatorToTag'
        db.create_table('indicator_to_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('indicator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Indicator'])),
            ('indicator_tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.IndicatorTag'])),
        ))
        db.send_create_signal(u'datapoints', ['IndicatorToTag'])


    def backwards(self, orm):
        # Deleting model 'IndicatorTag'
        db.delete_table('indicator_tag')

        # Deleting model 'IndicatorToTag'
        db.delete_table('indicator_to_tag')
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 26, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 26, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
