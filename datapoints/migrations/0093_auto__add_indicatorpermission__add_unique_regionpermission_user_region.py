...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndicatorPermission'
        db.create_table('indicator_permission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('indicator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Indicator'])),
        ))
        db.send_create_signal(u'datapoints', ['IndicatorPermission'])

        # Adding unique constraint on 'RegionPermission', fields ['user', 'region']
        db.create_unique('region_permission', ['user_id', 'region_id', 'read_write'])

        # Adding unique constraint on 'IndicatorPermission', fields ['user', 'region']
        db.create_unique('indicator_permission', ['group_id', 'indicator_id'])
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 5, 0, 0)'}),
        ...
        u'datapoints.indicatorpermission': {
            'Meta': {'object_name': 'IndicatorPermission', 'db_table': "'indicator_permission'"},
        ...
        u'datapoints.regionpermission': {
            'Meta': {'unique_together': "(('user', 'region'),)", 'object_name': 'RegionPermission', 'db_table': "'region_permission'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 5, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
