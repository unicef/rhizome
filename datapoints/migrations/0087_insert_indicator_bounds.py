...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        SELECT 431,NULL,-0.01,'invalid', 1 UNION ALL
        SELECT 431,-0.01,0.05,'good', 1 UNION ALL
        SELECT 431,0.05,0.09,'okay', 1 UNION ALL
        SELECT 431,0.09,1,'bad', 1 UNION ALL
        SELECT 431,1,NULL,'invalid', 1 UNION ALL
        SELECT 432,NULL,-0.01,'invalid', 1 UNION ALL
        SELECT 432,-0.01,0.05,'good', 1 UNION ALL
        ...
        SELECT 169,-0.01,0.75,'bad', 1 UNION ALL
        SELECT 169,NULL,-0.01,'invalid', 1 UNION ALL
        SELECT 233,1,NULL,'invalid', 1 UNION ALL
        SELECT 233,0.9,1,'good', 1 UNION ALL
        SELECT 233,0.75,0.89,'okay', 1 UNION ALL
        SELECT 233,-0.01,0.75,'bad', 1 UNION ALL
        SELECT 233,NULL,-0.01,'invalid', 1 UNION ALL
        SELECT 172,1,NULL,'invalid', 1 UNION ALL
        SELECT 172,0.79,1,'good', 1 UNION ALL
        SELECT 172,0.49,0.79,'okay', 1 UNION ALL
        SELECT 172,-0.01,0.49,'bad', 1 UNION ALL
        SELECT 172,NULL,-0.01,'invalid', 1 UNION ALL
        ...
        SELECT 187,-0.01,0.74,'bad', 1 UNION ALL
        SELECT 187,NULL,-0.01,'invalid', 1 UNION ALL
        SELECT 164,NULL,-0.01,'invalid', 1 UNION ALL
        SELECT 164,-0.01,0.009,'good', 1 UNION ALL
        ...
        SELECT 189,-0.01,0.59,'bad', 1 UNION ALL
        SELECT 189,NULL,-0.01,'invalid', 1 UNION ALL
        SELECT 245,1,NULL,'invalid', 1 UNION ALL
        SELECT 245,0.79,1,'good', 1 UNION ALL
        SELECT 245,0.6,0.79,'okay', 1 UNION ALL
        SELECT 245,-0.01,0.6,'bad', 1 UNION ALL
        SELECT 245,NULL,-0.01,'invalid', 1 UNION ALL
        SELECT 236,1,NULL,'invalid', 1 UNION ALL
        SELECT 236,0.79,1,'good', 1 UNION ALL
        SELECT 236,0.6,0.79,'okay', 1 UNION ALL
        SELECT 236,-0.01,0.6,'bad', 1 UNION ALL
        SELECT 236,NULL,-0.01,'invalid', 1 UNION ALL
        SELECT 191,NULL,-0.01,'invalid', 1 UNION ALL
        SELECT 191,-0.01,0.75,'good', 1 UNION ALL
        ...
        SELECT 193,-0.01,0.6,'bad', 1 UNION ALL
        SELECT 193,NULL,-0.01,'invalid', 1;
