...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CalculatedIndicatorComponent.calulation'
        db.delete_column('calculated_indicator_component', 'calulation')

        # Adding field 'CalculatedIndicatorComponent.calculation'
        db.add_column('calculated_indicator_component', 'calculation',
                      self.gf('django.db.models.fields.CharField')(default='PART', max_length=255),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CalculatedIndicatorComponent.calulation'
        raise RuntimeError("Cannot reverse this migration. 'CalculatedIndicatorComponent.calulation' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CalculatedIndicatorComponent.calulation'
        db.add_column('calculated_indicator_component', 'calulation',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'CalculatedIndicatorComponent.calculation'
        db.delete_column('calculated_indicator_component', 'calculation')
    ...
    models = {
        ...
        u'datapoints.parentregionagg': {
            'Meta': {'object_name': 'ParentRegionAgg', 'db_table': "'parent_region_agg'", 'managed': 'False'},
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Campaign']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indicator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Indicator']"}),
            'parent_region': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Region']"}),
            'the_sum': ('django.db.models.fields.FloatField', [], {})
        },
        u'datapoints.region': {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 15, 0, 0)'}),
