...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndicatorAbstracted'
        db.create_table('indicator_abstracted', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('indicator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Indicator'])),
            ('bound_json', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal(u'datapoints', ['IndicatorAbstracted'])


    def backwards(self, orm):
        # Deleting model 'IndicatorAbstracted'
        db.delete_table('indicator_abstracted')
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 21, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 21, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
