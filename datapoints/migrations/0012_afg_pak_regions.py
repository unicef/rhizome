...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        /* -- on the old server --
        DROP TABLE IF EXISTS to_ingest;
        CREATE TABLE to_ingest
        AS
        SELECT * FROM region
        WHERE office_id > 1
        ...
        SELECT
        	...
        	,ti.region_code
        	,ti.name
        	,ti_parent.region_code as parent_region_code
        	,rt.name
        FROM to_ingest ti
        INNER JOIN to_ingest ti_parent
        ON ti.parent_region_id = ti_parent.id
        INNER JOIN region_type rt
        ON ti.region_type_id = rt.id
        INNER JOIN office o
        ON ti.office_id = o.id
        AND o.name != 'Nigeria';
        ...
        */
        ...
        UPDATE region
        SET region_code = 'AF001000000000000000'
        WHERE region_code = 'AFG';

        UPDATE region
        SET region_code = 'PK001000000000000000'
        WHERE region_code = 'PAK';
