...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Region.parent_region'
        db.alter_column('region', 'parent_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Region.parent_region'
        raise RuntimeError("Cannot reverse this migration. 'Region.parent_region' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Region.parent_region'
        db.alter_column('region', 'parent_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region']))
