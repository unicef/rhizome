...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('source', (
            ...
            ('source_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=55)),
            ('source_description', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'datapoints', ['Source'])
