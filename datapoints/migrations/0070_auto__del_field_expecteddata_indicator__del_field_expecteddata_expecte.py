...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ExpectedData', fields ['region', 'campaign', 'indicator']
        db.delete_unique('expected_data', ['region_id', 'campaign_id', 'indicator_id'])

        # Deleting field 'ExpectedData.indicator'
        db.delete_column('expected_data', 'indicator_id')

        # Deleting field 'ExpectedData.expected_value'
        db.delete_column('expected_data', 'expected_value')

        # Deleting field 'ExpectedData.is_calc'
        db.delete_column('expected_data', 'is_calc')

        # Adding field 'ExpectedData.parent_region'
        db.add_column('expected_data', 'parent_region',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # Renaming column for 'ExpectedData.region' to match new field type.
        db.rename_column('expected_data', 'region_id', 'region')
        # Changing field 'ExpectedData.region'
        db.alter_column('expected_data', 'region', self.gf('django.db.models.fields.IntegerField')())
        # Removing index on 'ExpectedData', fields ['region']
        db.delete_index('expected_data', ['region_id'])

        # Adding unique constraint on 'ExpectedData', fields ['region', 'campaign']
        db.create_unique('expected_data', ['region', 'campaign_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ExpectedData', fields ['region', 'campaign']
        db.delete_unique('expected_data', ['region', 'campaign_id'])

        # Adding index on 'ExpectedData', fields ['region']
        db.create_index('expected_data', ['region_id'])


        # User chose to not deal with backwards NULL issues for 'ExpectedData.indicator'
        raise RuntimeError("Cannot reverse this migration. 'ExpectedData.indicator' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ExpectedData.indicator'
        db.add_column('expected_data', 'indicator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Indicator']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ExpectedData.expected_value'
        raise RuntimeError("Cannot reverse this migration. 'ExpectedData.expected_value' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ExpectedData.expected_value'
        db.add_column('expected_data', 'expected_value',
                      self.gf('django.db.models.fields.FloatField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ExpectedData.is_calc'
        raise RuntimeError("Cannot reverse this migration. 'ExpectedData.is_calc' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ExpectedData.is_calc'
        db.add_column('expected_data', 'is_calc',
                      self.gf('django.db.models.fields.BooleanField')(),
                      keep_default=False)

        # Deleting field 'ExpectedData.parent_region'
        db.delete_column('expected_data', 'parent_region')


        # Renaming column for 'ExpectedData.region' to match new field type.
        db.rename_column('expected_data', 'region', 'region_id')
        # Changing field 'ExpectedData.region'
        db.alter_column('expected_data', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region']))
        # Adding unique constraint on 'ExpectedData', fields ['region', 'campaign', 'indicator']
        db.create_unique('expected_data', ['region_id', 'campaign_id', 'indicator_id'])
    ...
    models = {
        ...
        u'datapoints.expecteddata': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Campaign']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_region': ('django.db.models.fields.IntegerField', [], {}),
