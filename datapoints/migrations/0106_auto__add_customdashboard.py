...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomDashboard'
        db.create_table('custom_dashboard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('default_region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region'])),
            ('data', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal(u'datapoints', ['CustomDashboard'])


    def backwards(self, orm):
        # Deleting model 'CustomDashboard'
        db.delete_table('custom_dashboard')
