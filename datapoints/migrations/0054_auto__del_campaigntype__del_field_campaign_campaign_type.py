...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CampaignType'
        db.delete_table(u'datapoints_campaigntype')

        # Deleting field 'Campaign.campaign_type'
        db.delete_column('campaign', 'campaign_type_id')


    def backwards(self, orm):
        # Adding model 'CampaignType'
        db.create_table(u'datapoints_campaigntype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=55)),
        ))
        db.send_create_signal(u'datapoints', ['CampaignType'])


        # User chose to not deal with backwards NULL issues for 'Campaign.campaign_type'
        raise RuntimeError("Cannot reverse this migration. 'Campaign.campaign_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Campaign.campaign_type'
        db.add_column('campaign', 'campaign_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.CampaignType']),
                      keep_default=False)
