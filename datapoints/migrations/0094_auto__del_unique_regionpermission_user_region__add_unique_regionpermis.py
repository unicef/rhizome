...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'RegionPermission', fields ['user', 'region']

        # Deleting field 'IndicatorAbstracted.indicator'
        db.delete_column('indicator_abstracted', 'indicator_id')

        # Adding field 'IndicatorAbstracted.description'
        db.add_column('indicator_abstracted', 'description',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding field 'IndicatorAbstracted.short_name'
        db.add_column('indicator_abstracted', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding field 'IndicatorAbstracted.slug'
        db.add_column('indicator_abstracted', 'slug',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding field 'IndicatorAbstracted.name'
        db.add_column('indicator_abstracted', 'name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'IndicatorAbstracted.indicator'
        db.add_column('indicator_abstracted', 'indicator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Indicator']),
                      keep_default=False)

        # Deleting field 'IndicatorAbstracted.description'
        db.delete_column('indicator_abstracted', 'description')

        # Deleting field 'IndicatorAbstracted.short_name'
        db.delete_column('indicator_abstracted', 'short_name')

        # Deleting field 'IndicatorAbstracted.slug'
        db.delete_column('indicator_abstracted', 'slug')

        # Deleting field 'IndicatorAbstracted.name'
        db.delete_column('indicator_abstracted', 'name')
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 8, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 8, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
