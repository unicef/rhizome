...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomDashboard.default_region'
        db.delete_column('custom_dashboard', 'default_region_id')

        # Adding field 'CustomDashboard.default_office'
        db.add_column('custom_dashboard', 'default_office',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['datapoints.Office']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CustomDashboard.default_region'
        raise RuntimeError("Cannot reverse this migration. 'CustomDashboard.default_region' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CustomDashboard.default_region'
        db.add_column('custom_dashboard', 'default_region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region']),
                      keep_default=False)

        # Deleting field 'CustomDashboard.default_office'
        db.delete_column('custom_dashboard', 'default_office_id')
    ...
    models = {
        ...
        u'datapoints.customdashboard': {
            ...
            'default_office': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Office']"}),
