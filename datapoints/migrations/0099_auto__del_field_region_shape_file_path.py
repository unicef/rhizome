...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Region.shape_file_path'
        db.delete_column('region', 'shape_file_path')


    def backwards(self, orm):
        # Adding field 'Region.shape_file_path'
        db.add_column('region', 'shape_file_path',
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 22, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 22, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
