...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomDashboard.json_data'
        db.delete_column('custom_dashboard', 'json_data')

        # Adding field 'CustomDashboard.dashboar_json'
        db.add_column('custom_dashboard', 'dashboard_json',
                      self.gf('jsonfield.fields.JSONField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'CustomDashboard', fields ['title']
        db.delete_unique('custom_dashboard', ['title'])


        # User chose to not deal with backwards NULL issues for 'CustomDashboard.json_data'
        raise RuntimeError("Cannot reverse this migration. 'CustomDashboard.json_data' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'CustomDashboard.json_data'
        db.add_column('custom_dashboard', 'json_data',
                      self.gf('jsonfield.fields.JSONField')(),
                      keep_default=False)

        # Deleting field 'CustomDashboard.dashboar_json'
        db.delete_column('custom_dashboard', 'dashboard_json')
    ...
    models = {
        ...
        u'datapoints.customdashboard': {
            ...
            'dashboar_json': ('jsonfield.fields.JSONField', [], {}),
