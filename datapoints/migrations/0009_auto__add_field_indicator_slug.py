...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('indicator', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='z', unique_with=(), max_length=50, populate_from='name'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.slug'
        db.delete_column('indicator', 'slug')
