...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('indicator', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['datapoints.Source']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.source'
        db.delete_column('indicator', 'source_id')
