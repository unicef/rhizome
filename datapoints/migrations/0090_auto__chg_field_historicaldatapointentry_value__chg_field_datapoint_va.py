...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'datapoints_historicaldatapointentry', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=5))

        # Changing field 'DataPoint.value'
        db.alter_column('datapoint', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=5))
    ...
    models = {
        ...
        u'datapoints.datapoint': {
            ...
            'value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '10'})
        },
