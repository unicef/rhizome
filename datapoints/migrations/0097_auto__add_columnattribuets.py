...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ColumnAttribuets'
        db.create_table('column_attributes', (
            ...
            ('display_on_table_flag', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'datapoints', ['ColumnAttribuets'])
        ...
        SELECT table_name, column_name, column_name, CAST(0 AS BOOLEAN) FROM information_schema.columns
        WHERE table_name in ('region', 'campaign','indicator','auth_user','auth_group');
    ...
    models = {
        ...
        u'datapoints.columnattribuets': {
            'Meta': {'object_name': 'ColumnAttribuets', 'db_table': "'column_attributes'"},
