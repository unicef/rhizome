...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Region.source_region'
        db.delete_column('region', 'source_region_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Region.source_region'
        raise RuntimeError("Cannot reverse this migration. 'Region.source_region' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'Region.source_region'
        db.add_column('region', 'source_region',
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 10, 0, 0)'}),
