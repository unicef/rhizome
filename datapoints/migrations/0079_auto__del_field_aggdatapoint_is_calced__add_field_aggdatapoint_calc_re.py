...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AggDataPoint.is_calced'
        db.delete_column('agg_datapoint', 'is_calced')
    ...
    def backwards(self, orm):
        # Adding field 'AggDataPoint.is_calced'
        db.add_column('agg_datapoint', 'is_calced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 16, 0, 0)'}),
