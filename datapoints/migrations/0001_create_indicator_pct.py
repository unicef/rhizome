...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indicator_pct', (
            ...
            ('indicator_part_id', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ind_part', to=orm['datapoints.Indicator'])),
            ('indicator_whole_id', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ind_whole', to=orm['datapoints.Indicator'])),
    ...
    models = {
        ...
        u'datapoints.indicatorpct': {
            'Meta': {'object_name': 'IndicatorPct', 'db_table': "'region_relationship'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
