...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campaign.note'
        db.delete_column('campaign', 'note')
        ...
        # Adding field 'Campaign.office'
        db.add_column('campaign', 'office',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['datapoints.Office']),
                      keep_default=False)

        # Adding field 'Campaign.slug'
        db.add_column('campaign', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default=1, unique_with=(), max_length=50, populate_from='name'),
                      keep_default=False)


        # Changing field 'Region.slug'
        db.alter_column('region', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=55, populate_from='full_name'))

    def backwards(self, orm):
        # Adding field 'Campaign.note'
        db.add_column('campaign', 'note',
        ...
        # Deleting field 'Campaign.office'
        db.delete_column('campaign', 'office_id')

        # Deleting field 'Campaign.slug'
        db.delete_column('campaign', 'slug')


        # Changing field 'Region.slug'
        db.alter_column('region', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=55, unique_with=(), populate_from='short_name'))
