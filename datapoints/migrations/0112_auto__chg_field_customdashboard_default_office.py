...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomDashboard.default_office'
        db.alter_column('custom_dashboard', 'default_office_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Office'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CustomDashboard.default_office'
        raise RuntimeError("Cannot reverse this migration. 'CustomDashboard.default_office' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CustomDashboard.default_office'
        db.alter_column('custom_dashboard', 'default_office_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Office']))
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 16, 0, 0)'}),
        ...
        u'source_data.document': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 16, 0, 0)'}),
