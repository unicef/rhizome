...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExpectedData'
        db.create_table('expected_data', (
            ...
            ('expected_value', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'datapoints', ['ExpectedData'])


    def backwards(self, orm):
        # Deleting model 'ExpectedData'
        db.delete_table('expected_data')
    ...
    models = {
        ...
        u'datapoints.expecteddata': {
            'Meta': {'object_name': 'ExpectedData', 'db_table': "'expected_data'"},
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Campaign']"}),
