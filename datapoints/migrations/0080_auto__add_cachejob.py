...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CacheJob'
        db.create_table('cache_job', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_attempted', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 17, 0, 0))),
            ('date_completed', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('is_error', self.gf('django.db.models.fields.BooleanField')()),
            ('response_msg', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'datapoints', ['CacheJob'])


    def backwards(self, orm):
        # Deleting model 'CacheJob'
        db.delete_table('cache_job')
    ...
    models = {
        ...
        u'datapoints.aggdatapoint': {
            ...
            'calc_refreshed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 17, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 17, 0, 0)'}),
