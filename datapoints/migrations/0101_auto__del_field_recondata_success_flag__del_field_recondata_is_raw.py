...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReconData.success_flag'
        db.delete_column('recon_data', 'success_flag')

        # Deleting field 'ReconData.is_raw'
        db.delete_column('recon_data', 'is_raw')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ReconData.success_flag'
        raise RuntimeError("Cannot reverse this migration. 'ReconData.success_flag' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ReconData.success_flag'
        db.add_column('recon_data', 'success_flag',
                      self.gf('django.db.models.fields.BooleanField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ReconData.is_raw'
        raise RuntimeError("Cannot reverse this migration. 'ReconData.is_raw' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ReconData.is_raw'
        db.add_column('recon_data', 'is_raw',
                      self.gf('django.db.models.fields.BooleanField')(),
                      keep_default=False)
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 27, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 27, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
