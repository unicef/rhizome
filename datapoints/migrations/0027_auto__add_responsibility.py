...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('responsibility', (
        ...
        db.send_create_signal(u'datapoints', ['Responsibility'])


    def backwards(self, orm):
        # Deleting model 'Responsibility'
        db.delete_table('responsibility')
    ...
    models = {
        ...
        u'datapoints.responsibility': {
            'Meta': {'object_name': 'Responsibility', 'db_table': "'responsibility'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indicator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Indicator']"}),
            'region': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Region']"}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 29, 0, 0)'}),
