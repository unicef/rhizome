...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserAuthFunction'
        db.create_table('user_auth_function', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('auth_code', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'datapoints', ['UserAuthFunction'])


    def backwards(self, orm):
        # Deleting model 'UserAuthFunction'
        db.delete_table('user_auth_function')
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 15, 0, 0)'}),
        ...
        u'source_data.document': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 15, 0, 0)'}),
