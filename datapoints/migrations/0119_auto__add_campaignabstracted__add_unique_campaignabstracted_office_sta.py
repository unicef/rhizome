...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CampaignAbstracted'
        db.create_table('campaign_abstracted', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('office', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Office'])),
            ('campaign_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.CampaignType'])),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from='get_full_name', unique_with=())),
            ('pct_complete', self.gf('django.db.models.fields.FloatField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'datapoints', ['CampaignAbstracted'])

        # Adding unique constraint on 'CampaignAbstracted', fields ['office', 'start_date']
        db.create_unique('campaign_abstracted', ['office_id', 'start_date'])


    def backwards(self, orm):
        # Removing unique constraint on 'CampaignAbstracted', fields ['office', 'start_date']
        db.delete_unique('campaign_abstracted', ['office_id', 'start_date'])

        # Deleting model 'CampaignAbstracted'
        db.delete_table('campaign_abstracted')
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 3, 0, 0)'}),
        ...
        u'datapoints.campaignabstracted': {
            'Meta': {'ordering': "('-start_date',)", 'unique_together': "(('office', 'start_date'),)", 'object_name': 'CampaignAbstracted', 'db_table': "'campaign_abstracted'"},
            'campaign_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.CampaignType']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'office': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Office']"}),
            'pct_complete': ('django.db.models.fields.FloatField', [], {}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': "'get_full_name'", 'unique_with': '()'}),
            'start_date': ('django.db.models.fields.DateField', [], {})
        },
        ...
        u'datapoints.customdashboard': {
            ...
            'default_office': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Office']", 'null': 'True'}),
        ...
        u'datapoints.userauthfunction': {
            'Meta': {'object_name': 'UserAuthFunction', 'db_table': "'user_auth_function'"},
            'auth_code': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        ...
        u'source_data.document': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 3, 0, 0)'}),
