...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataPointAbstracted.region_id'
        db.add_column('datapoint_abstracted', 'region_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'DataPointAbstracted.campaign_id'
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DataPointAbstracted.region'
        raise RuntimeError("Cannot reverse this migration. 'DataPointAbstracted.region' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DataPointAbstracted.region'
        db.add_column('datapoint_abstracted', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'DataPointAbstracted.campaign'
        raise RuntimeError("Cannot reverse this migration. 'DataPointAbstracted.campaign' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DataPointAbstracted.campaign'
        db.add_column('datapoint_abstracted', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Campaign']),
                      keep_default=False)
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 2, 0, 0)'}),
