...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RegionPermission'
        db.create_table('region_permission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region'])),
            ('read_write', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'datapoints', ['RegionPermission'])



    def backwards(self, orm):
        # Deleting model 'RegionPermission'
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 1, 0, 0)'}),
        ...
        u'datapoints.datapoint': {
            ...
            'value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '5'})
        },
        ...
        u'datapoints.regionpermission': {
            'Meta': {'object_name': 'RegionPermission', 'db_table': "'bad_data'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 1, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
