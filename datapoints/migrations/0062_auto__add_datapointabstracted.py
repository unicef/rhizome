...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DataPointAbstracted'
        db.create_table('datapoint_abstracted', (
            ...
            ('indicator_json', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal(u'datapoints', ['DataPointAbstracted'])


    def backwards(self, orm):
        # Deleting model 'DataPointAbstracted'
        db.delete_table('datapoint_abstracted')
    ...
    models = {
        ...
        u'datapoints.datapointabstracted': {
            'Meta': {'object_name': 'DataPointAbstracted', 'db_table': "'datapoint_abstracted'"},
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Campaign']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
