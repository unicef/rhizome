...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BadData'
        db.create_table('bad_data', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('datapoint', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.DataPoint'])),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.Document'])),
            ('error_type', self.gf('django.db.models.fields.CharField')(max_length=55)),
            ('cache_job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.CacheJob'])),
        ))
        db.send_create_signal(u'datapoints', ['BadData'])


    def backwards(self, orm):
        # Deleting model 'BadData'
        db.delete_table('bad_data')
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 26, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 26, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
