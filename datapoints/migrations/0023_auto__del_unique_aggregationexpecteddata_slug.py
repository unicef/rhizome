...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('aggregation_expected_data', ['slug'])


    def backwards(self, orm):
        # Adding unique constraint on 'AggregationExpectedData', fields ['slug']
        db.create_unique('aggregation_expected_data', ['slug'])
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 7, 0, 0)'}),
