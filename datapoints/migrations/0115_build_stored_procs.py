...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        subprocess.call(["bash", "bin/build_db.sh"])
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 18, 0, 0)'}),
        ...
        u'source_data.document': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 18, 0, 0)'}),
