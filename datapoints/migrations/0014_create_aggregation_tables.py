...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('aggregation_type', (
            ...
            ('fn_lookup', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ...
        db.alter_column('campaign', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from='get_full_name'))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Campaign.slug'
        db.alter_column('campaign', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from='name'))
