...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalDataPoint.office_id'
        db.add_column(u'datapoints_historicaldatapoint', 'office_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Region.office'
        db.add_column('region', 'office',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['datapoints.Office']),
                      keep_default=False)

        # Adding field 'DataPoint.office'
        db.add_column('datapoint', 'office',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['datapoints.Office']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalDataPoint.office_id'
        db.delete_column(u'datapoints_historicaldatapoint', 'office_id')

        # Deleting field 'Region.office'
        db.delete_column('region', 'office_id')

        # Deleting field 'DataPoint.office'
        db.delete_column('datapoint', 'office_id')
    ...
    models = {
        ...
        u'datapoints.historicaldatapoint': {
            ...
            'note': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'office_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
