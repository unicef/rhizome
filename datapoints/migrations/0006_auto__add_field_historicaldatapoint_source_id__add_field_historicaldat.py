...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HistoricalDataPoint.source_guid'
        db.add_column(u'datapoints_historicaldatapoint', 'source_guid',
                      self.gf('django.db.models.fields.CharField')(default='afaf', max_length=255),
                      keep_default=False)

        # Adding field 'Region.source_guid'
        db.add_column('region', 'source_guid',
                      self.gf('django.db.models.fields.CharField')(default='asfaf', max_length=255),
                      keep_default=False)
        ...
        # Adding field 'DataPoint.source_guid'
        db.add_column('datapoint', 'source_guid',
                      self.gf('django.db.models.fields.CharField')(default='asfavavav', max_length=255),
                      keep_default=False)
