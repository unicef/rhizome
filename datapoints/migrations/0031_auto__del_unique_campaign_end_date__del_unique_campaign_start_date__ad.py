...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Campaign', fields ['start_date']
        db.delete_unique('campaign', ['start_date'])

        # Removing unique constraint on 'Campaign', fields ['end_date']
        db.delete_unique('campaign', ['end_date'])

        # Adding unique constraint on 'Campaign', fields ['office', 'start_date']
        db.create_unique('campaign', ['office_id', 'start_date'])


        # Changing field 'Region.slug'
        db.alter_column('region', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=55, populate_from='name'))

    def backwards(self, orm):
        # Removing unique constraint on 'Campaign', fields ['office', 'start_date']
        db.delete_unique('campaign', ['office_id', 'start_date'])

        # Adding unique constraint on 'Campaign', fields ['end_date']
        db.create_unique('campaign', ['end_date'])

        # Adding unique constraint on 'Campaign', fields ['start_date']
        db.create_unique('campaign', ['start_date'])


        # Changing field 'Region.slug'
        db.alter_column('region', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=55, unique_with=(), populate_from='full_name'))
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 3, 0, 0)'}),
