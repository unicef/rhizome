...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomDashboard.dashboard_json'
        db.alter_column('custom_dashboard', 'dashboard_json', self.gf('jsonfield.fields.JSONField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CustomDashboard.dashboard_json'
        raise RuntimeError("Cannot reverse this migration. 'CustomDashboard.dashboard_json' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CustomDashboard.dashboard_json'
        db.alter_column('custom_dashboard', 'dashboard_json', self.gf('jsonfield.fields.JSONField')())
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 23, 0, 0)'}),
