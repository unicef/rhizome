...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('region', 'region_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10))

    def backwards(self, orm):

        # Changing field 'Region.region_code'
        db.alter_column('region', 'region_code', self.gf('django.db.models.fields.IntegerField')(unique=True))
