...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('region', 'region_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Region.name'
        db.alter_column('region', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Region.region_code'
        db.alter_column('region', 'region_code', self.gf('django.db.models.fields.CharField')(max_length=55, unique=True))

        # Changing field 'Region.name'
        db.alter_column('region', 'name', self.gf('django.db.models.fields.CharField')(max_length=55, unique=True))
