...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Region.region_type'
        db.add_column('region', 'region_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.RegionType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Region.region_type'
        db.delete_column('region', 'region_type_id')
    ...
    models = {
        ...
        u'datapoints.region': {
            ...
            'region_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.RegionType']", 'null': 'True'}),
