...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('campaign', ['slug'])

        # Adding unique constraint on 'Region', fields ['slug']
        db.create_unique('region', ['slug'])

        # Adding unique constraint on 'Indicator', fields ['short_name']
        db.create_unique('indicator', ['short_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Indicator', fields ['short_name']
        db.delete_unique('indicator', ['short_name'])

        # Removing unique constraint on 'Region', fields ['slug']
        db.delete_unique('region', ['slug'])

        # Removing unique constraint on 'Campaign', fields ['slug']
        db.delete_unique('campaign', ['slug'])
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 29, 0, 0)'}),
