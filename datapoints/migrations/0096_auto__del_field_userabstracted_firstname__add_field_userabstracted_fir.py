...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserAbstracted.firstname'
        db.delete_column('user_abstracted', 'firstname')

        # Adding field 'UserAbstracted.first_name'
        db.add_column('user_abstracted', 'first_name',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'UserAbstracted.firstname'
        raise RuntimeError("Cannot reverse this migration. 'UserAbstracted.firstname' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'UserAbstracted.firstname'
        db.add_column('user_abstracted', 'firstname',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'UserAbstracted.first_name'
        db.delete_column('user_abstracted', 'first_name')
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 12, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 12, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
