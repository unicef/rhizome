...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IndicatorBound.direction'
        db.add_column('indicator_bound', 'direction',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IndicatorBound.direction'
        db.delete_column('indicator_bound', 'direction')
