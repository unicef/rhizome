...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IndicatorBound.mx_val'
        db.alter_column('indicator_bound', 'mx_val', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'IndicatorBound.mn_val'
        db.alter_column('indicator_bound', 'mn_val', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'IndicatorBound.mx_val'
        raise RuntimeError("Cannot reverse this migration. 'IndicatorBound.mx_val' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'IndicatorBound.mx_val'
        db.alter_column('indicator_bound', 'mx_val', self.gf('django.db.models.fields.FloatField')())

        # User chose to not deal with backwards NULL issues for 'IndicatorBound.mn_val'
        raise RuntimeError("Cannot reverse this migration. 'IndicatorBound.mn_val' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'IndicatorBound.mn_val'
        db.alter_column('indicator_bound', 'mn_val', self.gf('django.db.models.fields.FloatField')())
