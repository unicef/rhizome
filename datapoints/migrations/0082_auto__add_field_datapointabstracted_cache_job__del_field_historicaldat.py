...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataPointAbstracted.cache_job'
        db.add_column('datapoint_abstracted', 'cache_job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['datapoints.CacheJob']),
                      keep_default=False)

        # Deleting field 'HistoricalDataPointEntry.is_cached'
        db.delete_column(u'datapoints_historicaldatapointentry', 'is_cached')

        # Adding field 'HistoricalDataPointEntry.cache_job_id'
        db.add_column(u'datapoints_historicaldatapointentry', 'cache_job_id',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Deleting field 'AggDataPoint.calc_refreshed'
        db.delete_column('agg_datapoint', 'calc_refreshed')

        # Adding field 'AggDataPoint.cache_job'
        db.add_column('agg_datapoint', 'cache_job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['datapoints.CacheJob']),
                      keep_default=False)

        # Adding field 'DataPointComputed.cache_job'
        db.add_column('datapoint_with_computed', 'cache_job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['datapoints.CacheJob']),
                      keep_default=False)

        # Deleting field 'DataPoint.is_cached'
        db.delete_column('datapoint', 'is_cached')

        # Adding field 'DataPoint.cache_job'
        db.add_column('datapoint', 'cache_job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['datapoints.CacheJob']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataPointAbstracted.cache_job'
        db.delete_column('datapoint_abstracted', 'cache_job_id')

        # Adding field 'HistoricalDataPointEntry.is_cached'
        db.add_column(u'datapoints_historicaldatapointentry', 'is_cached',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'HistoricalDataPointEntry.cache_job_id'
        db.delete_column(u'datapoints_historicaldatapointentry', 'cache_job_id')

        # Adding field 'AggDataPoint.calc_refreshed'
        db.add_column('agg_datapoint', 'calc_refreshed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AggDataPoint.cache_job'
        db.delete_column('agg_datapoint', 'cache_job_id')

        # Deleting field 'DataPointComputed.cache_job'
        db.delete_column('datapoint_with_computed', 'cache_job_id')

        # Adding field 'DataPoint.is_cached'
        db.add_column('datapoint', 'is_cached',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'DataPoint.cache_job'
        db.delete_column('datapoint', 'cache_job_id')
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)'}),
