...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AggregationExpectedData.created_at'
        db.add_column('aggregation_expected_data', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'AggregationType.created_at'
        db.add_column('aggregation_type', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AggregationExpectedData.created_at'
        db.delete_column('aggregation_expected_data', 'created_at')

        # Deleting field 'AggregationType.created_at'
        db.delete_column('aggregation_type', 'created_at')
    ...
    models = {
        ...
        u'datapoints.aggregationtype': {
            ...
            'fn_lookup': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
