...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Region', fields ['region_code']
        db.create_unique('region', ['region_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'Region', fields ['region_code']
        db.delete_unique('region', ['region_code'])
    ...
    models = {
        ...
        u'datapoints.region': {
            ...
            'office': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Office']"}),
            'region_code': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 6, 0, 0)'}),
