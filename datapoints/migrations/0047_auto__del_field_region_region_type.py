...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Region.region_type'
        db.delete_column('region', 'region_type')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Region.region_type'
        raise RuntimeError("Cannot reverse this migration. 'Region.region_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Region.region_type'
        db.add_column('region', 'region_type',
