...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IndicatorAbstracted.tag_json'
        db.add_column('indicator_abstracted', 'tag_json',
                      self.gf('jsonfield.fields.JSONField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IndicatorAbstracted.tag_json'
        db.delete_column('indicator_abstracted', 'tag_json')
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 28, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 28, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
