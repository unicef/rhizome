...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CalculatedIndicatorComponent.created_at'
        db.add_column('calculated_indicator_component', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default='2014-01-01', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CalculatedIndicatorComponent.created_at'
        db.delete_column('calculated_indicator_component', 'created_at')
    ...
    models = {
        ...
        u'datapoints.calculatedindicatorcomponent': {
            ...
            'calulation': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
