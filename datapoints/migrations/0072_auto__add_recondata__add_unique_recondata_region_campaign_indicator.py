...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReconData'
        db.create_table('recon_data', (
            ...
            ('target_value', self.gf('django.db.models.fields.FloatField')()),
            ('is_raw', self.gf('django.db.models.fields.BooleanField')()),
            ('success_flag', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'datapoints', ['ReconData'])

        # Adding unique constraint on 'ReconData', fields ['region', 'campaign', 'indicator']
        db.create_unique('recon_data', ['region_id', 'campaign_id', 'indicator_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ReconData', fields ['region', 'campaign', 'indicator']
        db.delete_unique('recon_data', ['region_id', 'campaign_id', 'indicator_id'])

        # Deleting model 'ReconData'
        db.delete_table('recon_data')
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 26, 0, 0)'}),
