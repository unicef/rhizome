...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CustomDashboard.data'
        db.delete_column('custom_dashboard', 'data')

        # Adding field 'CustomDashboard.json_data'
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CustomDashboard.data'
        raise RuntimeError("Cannot reverse this migration. 'CustomDashboard.data' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CustomDashboard.data'
        db.add_column('custom_dashboard', 'data',
    ...
    models = {
        ...
        u'datapoints.cachejob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 9, 0, 0)'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 9, 0, 0)'}),
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
