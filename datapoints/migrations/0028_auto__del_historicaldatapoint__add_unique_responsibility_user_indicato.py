...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Responsibility', fields ['user', 'indicator', 'region']
        db.create_unique('responsibility', ['user_id', 'indicator_id', 'region_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Responsibility', fields ['user', 'indicator', 'region']
        db.delete_unique('responsibility', ['user_id', 'indicator_id', 'region_id'])

        # Adding model 'HistoricalDataPoint'
        db.create_table(u'datapoints_historicaldatapoint', (
            ('region_id', self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True)),
            (u'history_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campaign_id', self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True)),
            ('changed_by_id', self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True)),
            ('source_datapoint_id', self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True)),
            ...
            ('indicator_id', self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True)),
    ...
    models = {
        ...
        u'datapoints.campaign': {
            'Meta': {'ordering': "('-start_date',)", 'object_name': 'Campaign', 'db_table': "'campaign'"},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'datapoints.region': {
            'Meta': {'ordering': "('full_name',)", 'unique_together': "(('source', 'source_guid'),)", 'object_name': 'Region', 'db_table': "'region'"},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 30, 0, 0)'}),
