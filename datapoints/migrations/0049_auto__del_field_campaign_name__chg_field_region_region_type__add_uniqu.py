...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('campaign', 'name')


        # Changing field 'Region.region_type'
        db.alter_column('region', 'region_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['datapoints.RegionType']))
        # Adding unique constraint on 'Region', fields ['name', 'region_type', 'office']
        db.create_unique('region', ['name', 'region_type_id', 'office_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Region', fields ['name', 'region_type', 'office']
        db.delete_unique('region', ['name', 'region_type_id', 'office_id'])
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Campaign.name'
        db.add_column('campaign', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)


        # Changing field 'Region.region_type'
        db.alter_column('region', 'region_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.RegionType'], null=True))
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 22, 0, 0)'}),
