...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('indicator', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=255, populate_from='name', unique_with=()))

    def backwards(self, orm):

        # Changing field 'Indicator.slug'
        db.alter_column('indicator', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=55, unique_with=(), unique=True, populate_from='name'))
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 1, 0, 0)'}),
