...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ExpectedData.parent_region' to match new field type.
        db.rename_column('expected_data', 'parent_region', 'parent_region_id')
        # Changing field 'ExpectedData.parent_region'
        db.alter_column('expected_data', 'parent_region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region']))
        # Adding index on 'ExpectedData', fields ['parent_region']
        db.create_index('expected_data', ['parent_region_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'ExpectedData', fields ['parent_region']
        db.delete_index('expected_data', ['parent_region_id'])


        # Renaming column for 'ExpectedData.parent_region' to match new field type.
        db.rename_column('expected_data', 'parent_region_id', 'parent_region')
        # Changing field 'ExpectedData.parent_region'
        db.alter_column('expected_data', 'parent_region', self.gf('django.db.models.fields.IntegerField')())
