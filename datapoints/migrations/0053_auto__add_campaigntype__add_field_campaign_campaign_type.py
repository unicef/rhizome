...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Campaign.campaign_type'
        db.add_column('campaign', 'campaign_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['datapoints.CampaignType']),
                      keep_default=False)
