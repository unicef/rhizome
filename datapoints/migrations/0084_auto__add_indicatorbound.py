...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndicatorBound'
        db.create_table('indicator_bound', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('indicator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Indicator'])),
            ('mn_val', self.gf('django.db.models.fields.FloatField')()),
            ('mx_val', self.gf('django.db.models.fields.FloatField')()),
            ('bound_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'datapoints', ['IndicatorBound'])


    def backwards(self, orm):
        # Deleting model 'IndicatorBound'
        db.delete_table('indicator_bound')
    ...
    models = {
        ...
        u'datapoints.indicatorbound': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indicator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Indicator']"}),
            'mn_val': ('django.db.models.fields.FloatField', [], {}),
            'mx_val': ('django.db.models.fields.FloatField', [], {})
        },
