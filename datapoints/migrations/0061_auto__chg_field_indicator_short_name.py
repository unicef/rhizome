...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Indicator.short_name'
        db.alter_column('indicator', 'short_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Indicator.short_name'
        db.alter_column('indicator', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=55, unique=True))
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 19, 0, 0)'}),
