...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Region.parent_region_id'
        db.delete_column('region', 'parent_region_id_id')

        # Adding field 'Region.parent_region'
        db.add_column('region', 'parent_region',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=128, to=orm['datapoints.Region']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Region.parent_region_id'
        db.add_column('region', 'parent_region_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=128, to=orm['datapoints.Region']),
                      keep_default=False)

        # Deleting field 'Region.parent_region'
        db.delete_column('region', 'parent_region_id')
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 26, 0, 0)'}),
