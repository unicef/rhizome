...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SourceRegionPolygon'
        db.delete_table('region_polygon')

        # Adding model 'RegionPolygon'
        db.create_table('region_polygon', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region'], unique=True)),
            ('shape_len', self.gf('django.db.models.fields.FloatField')()),
            ('shape_area', self.gf('django.db.models.fields.FloatField')()),
            ('polygon', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal(u'datapoints', ['RegionPolygon'])


    def backwards(self, orm):
        # Adding model 'SourceRegionPolygon'
        db.create_table('region_polygon', (
            ('shape_area', self.gf('django.db.models.fields.FloatField')()),
            ('polygon', self.gf('django.db.models.fields.TextField')()),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region'], unique=True)),
            ('shape_len', self.gf('django.db.models.fields.FloatField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'datapoints', ['SourceRegionPolygon'])

        # Deleting model 'RegionPolygon'
        db.delete_table('region_polygon')
    ...
    models = {
        ...
        u'datapoints.abstracteddatapoint': {
            'Meta': {'object_name': 'AbstractedDataPoint', 'db_table': "'vw_datapoint'", 'managed': 'False'},
        ...
        'source_data.sourcedatapoint': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 15, 0, 0)'}),
