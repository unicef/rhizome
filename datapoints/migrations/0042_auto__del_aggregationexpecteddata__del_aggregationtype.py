...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('aggregation_expected_data', (
            ...
            ('slug', self.gf('autoslug.fields.AutoSlugField')(max_length=55, unique_with=(), populate_from=('aggregation_type', 'content_type'))),
        ...
        db.create_table('aggregation_type', (
            ...
            ('display_name_w_sub', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
