...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalDataPoint.indicator_id_id'
        db.add_column(u'datapoints_historicaldatapoint', 'indicator',
                      self.gf('django.db.models.fields.IntegerField')(db_index=False, null=True, blank=True),
                      keep_default=False)

        db.add_column(u'datapoints_historicaldatapoint', 'region',
                      self.gf('django.db.models.fields.IntegerField')(db_index=False, null=True, blank=True),
                      keep_default=False)

        db.add_column(u'datapoints_historicaldatapoint', 'campaign',
                      self.gf('django.db.models.fields.IntegerField')(db_index=False, null=True, blank=True),
                      keep_default=False)

        db.add_column(u'datapoints_historicaldatapoint', 'changed_by',
                      self.gf('django.db.models.fields.IntegerField')(db_index=False, null=True, blank=True),
                      keep_default=False)

        db.add_column(u'datapoints_historicaldatapoint', 'source',
                      self.gf('django.db.models.fields.IntegerField')(db_index=False, null=True, blank=True),
                      keep_default=False)
