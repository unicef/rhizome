...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EtlJob.cron_guid'
        db.add_column(u'source_data_etljob', 'cron_guid',
                      self.gf('django.db.models.fields.CharField')(default='fillinginwithmigration', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EtlJob.cron_guid'
        db.delete_column(u'source_data_etljob', 'cron_guid')
