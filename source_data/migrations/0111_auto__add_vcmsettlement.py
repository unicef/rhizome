...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('odk_vcm_settlement', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table('odk_vcm_settlement')
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 1, 0, 0)'}),
        ...
        u'source_data.etljob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 1, 0, 0)'}),
