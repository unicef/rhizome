...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'DocumentMeta'
        db.delete_table('document_meta')


    def backwards(self, orm):
        # Adding model 'DocumentMeta'
        db.create_table('document_meta', (
            ('model_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('source_datapoint_count', self.gf('django.db.models.fields.IntegerField')()),
            ('master_object_id', self.gf('django.db.models.fields.IntegerField')()),
            ('source_object_id', self.gf('django.db.models.fields.IntegerField')()),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.Document'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_string', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'source_data', ['DocumentMeta'])
