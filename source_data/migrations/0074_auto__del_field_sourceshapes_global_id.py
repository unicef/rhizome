...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SourceShapes.global_id'
        db.delete_column(u'source_data_sourceshapes', 'global_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SourceShapes.global_id'
        raise RuntimeError("Cannot reverse this migration. 'SourceShapes.global_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceShapes.global_id'
        db.add_column(u'source_data_sourceshapes', 'global_id',
