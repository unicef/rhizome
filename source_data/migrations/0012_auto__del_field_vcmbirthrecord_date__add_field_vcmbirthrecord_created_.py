...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VCMBirthRecord.created_at'
        db.add_column(u'source_data_vcmbirthrecord', 'created_at',
        ...
        # Adding field 'VCMSettlement.created_at'
        db.add_column(u'source_data_vcmsettlement', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 5, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VCMBirthRecord.created_at'
        db.delete_column(u'source_data_vcmbirthrecord', 'created_at')
        ...
        # Deleting field 'VCMSettlement.created_at'
        db.delete_column(u'source_data_vcmsettlement', 'created_at')
