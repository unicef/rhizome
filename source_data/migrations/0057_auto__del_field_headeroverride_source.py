...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HeaderOverride.source'
        db.delete_column(u'source_data_headeroverride', 'source_id')


    def backwards(self, orm):
        # Adding field 'HeaderOverride.source'
        db.add_column(u'source_data_headeroverride', 'source',
