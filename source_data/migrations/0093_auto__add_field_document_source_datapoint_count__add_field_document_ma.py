...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.source_datapoint_count'
        db.add_column(u'source_data_document', 'source_datapoint_count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Document.master_datapoint_count'
        db.add_column(u'source_data_document', 'master_datapoint_count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.source_datapoint_count'
        db.delete_column(u'source_data_document', 'source_datapoint_count')

        # Deleting field 'Document.master_datapoint_count'
        db.delete_column(u'source_data_document', 'master_datapoint_count')
    ...
    models = {
        ...
        u'source_data.document': {
            ...
            'master_datapoint_count': ('django.db.models.fields.IntegerField', [], {}),
