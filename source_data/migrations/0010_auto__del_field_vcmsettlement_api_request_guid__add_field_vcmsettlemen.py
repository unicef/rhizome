...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VCMSettlement.api_request_guid'
        db.delete_column(u'source_data_vcmsettlement', 'api_request_guid')

        # Adding field 'VCMSettlement.request_guid'
        db.add_column(u'source_data_vcmsettlement', 'request_guid',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'VCMSettlement.api_request_guid'
        raise RuntimeError("Cannot reverse this migration. 'VCMSettlement.api_request_guid' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'VCMSettlement.api_request_guid'
        db.add_column(u'source_data_vcmsettlement', 'api_request_guid',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'VCMSettlement.request_guid'
        db.delete_column(u'source_data_vcmsettlement', 'request_guid')
    ...
    models = {
        ...
        'source_data.vcmbirthrecord': {
            ...
            'api_request_guid': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
