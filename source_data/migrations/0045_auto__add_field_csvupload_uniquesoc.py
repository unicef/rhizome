...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CsvUpload.uniquesoc'
        db.add_column(u'source_data_csvupload', 'uniquesoc',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CsvUpload.uniquesoc'
        db.delete_column(u'source_data_csvupload', 'uniquesoc')
    ...
    models = {
        ...
        'source_data.csvupload': {
            ...
            'uniquesoc': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
