...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.source_datapoint_count'
        db.alter_column(u'source_data_document', 'source_datapoint_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Document.master_datapoint_count'
        db.alter_column(u'source_data_document', 'master_datapoint_count', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Document.source_datapoint_count'
        raise RuntimeError("Cannot reverse this migration. 'Document.source_datapoint_count' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Document.source_datapoint_count'
        db.alter_column(u'source_data_document', 'source_datapoint_count', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'Document.master_datapoint_count'
        raise RuntimeError("Cannot reverse this migration. 'Document.master_datapoint_count' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Document.master_datapoint_count'
        db.alter_column(u'source_data_document', 'master_datapoint_count', self.gf('django.db.models.fields.IntegerField')())
