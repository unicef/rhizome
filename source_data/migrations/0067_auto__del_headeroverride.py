...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'HeaderOverride'
        db.delete_table(u'source_data_headeroverride')
        db.rename_table('source_data_sourcedatapoint', 'source_datapoint')
        db.rename_table('source_data_sourceregion', 'source_region')
        db.rename_table('source_data_sourceindicator', 'source_indicator')
        db.rename_table('source_data_sourcecampaign', 'source_campaign')
        db.rename_table('source_data_regionmap', 'region_map')
        db.rename_table('source_data_indicatormap', 'indicator_map')
        db.rename_table('source_data_campaignmap', 'campaign_map')
