...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SourceIndicator.document_id'
        db.delete_column(u'source_data_sourceindicator', 'document_id_id')

        # Adding field 'SourceIndicator.document'
        db.add_column(u'source_data_sourceindicator', 'document',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['source_data.Document']),
                      keep_default=False)

        # Deleting field 'SourceRegion.document_id'
        db.delete_column(u'source_data_sourceregion', 'document_id_id')

        # Adding field 'SourceRegion.document'
        db.add_column(u'source_data_sourceregion', 'document',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['source_data.Document']),
                      keep_default=False)

        # Deleting field 'SourceCampaign.document_id'
        db.delete_column(u'source_data_sourcecampaign', 'document_id_id')

        # Adding field 'SourceCampaign.document'
        db.add_column(u'source_data_sourcecampaign', 'document',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['source_data.Document']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'SourceIndicator.document_id'
        raise RuntimeError("Cannot reverse this migration. 'SourceIndicator.document_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceIndicator.document_id'
        db.add_column(u'source_data_sourceindicator', 'document_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.Document']),
                      keep_default=False)

        # Deleting field 'SourceIndicator.document'
        db.delete_column(u'source_data_sourceindicator', 'document_id')


        # User chose to not deal with backwards NULL issues for 'SourceRegion.document_id'
        raise RuntimeError("Cannot reverse this migration. 'SourceRegion.document_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceRegion.document_id'
        db.add_column(u'source_data_sourceregion', 'document_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.Document']),
                      keep_default=False)

        # Deleting field 'SourceRegion.document'
        db.delete_column(u'source_data_sourceregion', 'document_id')


        # User chose to not deal with backwards NULL issues for 'SourceCampaign.document_id'
        raise RuntimeError("Cannot reverse this migration. 'SourceCampaign.document_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceCampaign.document_id'
        db.add_column(u'source_data_sourcecampaign', 'document_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.Document']),
                      keep_default=False)

        # Deleting field 'SourceCampaign.document'
        db.delete_column(u'source_data_sourcecampaign', 'document_id')
    ...
    models = {
        ...
        u'source_data.sourceregion': {
            'Meta': {'unique_together': "(('source', 'region_string'),)", 'object_name': 'SourceRegion'},
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
