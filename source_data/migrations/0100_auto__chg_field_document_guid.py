...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.guid'
        db.alter_column(u'source_data_document', 'guid', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Document.guid'
        db.alter_column(u'source_data_document', 'guid', self.gf('django.db.models.fields.CharField')(max_length=40))
