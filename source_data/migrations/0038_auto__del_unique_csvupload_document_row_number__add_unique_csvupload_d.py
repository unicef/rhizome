...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CsvUpload', fields ['document', 'row_number']
        db.delete_unique(u'source_data_csvupload', ['document_id', 'row_number'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'CsvUpload', fields ['document', 'row_number']
        db.create_unique(u'source_data_csvupload', ['document_id', 'row_number'])
    ...
    models = {
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 18, 0, 0)'}),
