...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceRegion.lon'
        db.alter_column(u'source_data_sourceregion', 'lon', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SourceRegion.settlement_code'
        db.alter_column(u'source_data_sourceregion', 'settlement_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SourceRegion.lat'
        db.alter_column(u'source_data_sourceregion', 'lat', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SourceRegion.lon'
        raise RuntimeError("Cannot reverse this migration. 'SourceRegion.lon' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SourceRegion.lon'
        db.alter_column(u'source_data_sourceregion', 'lon', self.gf('django.db.models.fields.CharField')(max_length=255))

        # User chose to not deal with backwards NULL issues for 'SourceRegion.settlement_code'
        raise RuntimeError("Cannot reverse this migration. 'SourceRegion.settlement_code' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SourceRegion.settlement_code'
        db.alter_column(u'source_data_sourceregion', 'settlement_code', self.gf('django.db.models.fields.CharField')(max_length=255))

        # User chose to not deal with backwards NULL issues for 'SourceRegion.lat'
        raise RuntimeError("Cannot reverse this migration. 'SourceRegion.lat' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SourceRegion.lat'
        db.alter_column(u'source_data_sourceregion', 'lat', self.gf('django.db.models.fields.CharField')(max_length=255))
