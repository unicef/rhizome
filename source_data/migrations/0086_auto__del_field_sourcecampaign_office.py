...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SourceCampaign.office'
        db.delete_column('source_campaign', 'office_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SourceCampaign.office'
        raise RuntimeError("Cannot reverse this migration. 'SourceCampaign.office' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceCampaign.office'
        db.add_column('source_campaign', 'office',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Office']),
                      keep_default=False)
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 11, 0, 0)'}),
