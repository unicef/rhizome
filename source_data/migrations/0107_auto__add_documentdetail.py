...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentDetail'
        db.create_table('document_detail', (
            ...
            ('source_dp_count', self.gf('django.db.models.fields.IntegerField')()),
            ('master_dp_count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'source_data', ['DocumentDetail'])


    def backwards(self, orm):
        # Deleting model 'DocumentDetail'
        db.delete_table('document_detail')
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 19, 0, 0)'}),
        ...
        u'source_data.etljob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 19, 0, 0)'}),
