...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SourceRegion.settlement_code'
        db.delete_column(u'source_data_sourceregion', 'settlement_code')

        # Adding field 'SourceRegion.region_code'
        db.add_column(u'source_data_sourceregion', 'region_code',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'SourceRegion.parent_name'
        db.add_column(u'source_data_sourceregion', 'parent_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'SourceRegion.parent_code'
        db.add_column(u'source_data_sourceregion', 'parent_code',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'SourceRegion.region_type'
        db.add_column(u'source_data_sourceregion', 'region_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'SourceRegion.country'
        db.add_column(u'source_data_sourceregion', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SourceRegion.settlement_code'
        db.add_column(u'source_data_sourceregion', 'settlement_code',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'SourceRegion.region_code'
        db.delete_column(u'source_data_sourceregion', 'region_code')

        # Deleting field 'SourceRegion.parent_name'
        db.delete_column(u'source_data_sourceregion', 'parent_name')

        # Deleting field 'SourceRegion.parent_code'
        db.delete_column(u'source_data_sourceregion', 'parent_code')

        # Deleting field 'SourceRegion.region_type'
        db.delete_column(u'source_data_sourceregion', 'region_type')

        # Deleting field 'SourceRegion.country'
        db.delete_column(u'source_data_sourceregion', 'country')
