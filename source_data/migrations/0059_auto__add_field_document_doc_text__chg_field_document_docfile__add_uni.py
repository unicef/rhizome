...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.doc_text'
        db.add_column(u'source_data_document', 'doc_text',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


        # Changing field 'Document.docfile'
        db.alter_column(u'source_data_document', 'docfile', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
        # Adding unique constraint on 'Document', fields ['docfile', 'doc_text']
        db.create_unique(u'source_data_document', ['docfile', 'doc_text'])


    def backwards(self, orm):
        # Removing unique constraint on 'Document', fields ['docfile', 'doc_text']
        db.delete_unique(u'source_data_document', ['docfile', 'doc_text'])

        # Deleting field 'Document.doc_text'
        db.delete_column(u'source_data_document', 'doc_text')


        # User chose to not deal with backwards NULL issues for 'Document.docfile'
        raise RuntimeError("Cannot reverse this migration. 'Document.docfile' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Document.docfile'
        db.alter_column(u'source_data_document', 'docfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))
