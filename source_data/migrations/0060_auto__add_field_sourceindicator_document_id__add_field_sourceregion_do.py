...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceIndicator.document_id'
        ...
        # Adding field 'SourceRegion.document_id'
        db.add_column(u'source_data_sourceregion', 'document_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['source_data.Document']),
                      keep_default=False)

        # Adding field 'SourceCampaign.document_id'
    ...
    models = {
        ...
        u'source_data.sourcecampaign': {
            ...
            'document_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.Document']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Source']"}),
            'source_guid': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
