...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SourceRegionShape'
        db.delete_table('source_shapes')

        # Adding model 'SourceRegionPolygon'
        db.create_table('source_region_polygons', (
            ...
            ('lon', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'source_data', ['SourceRegionPolygon'])


    def backwards(self, orm):
        # Adding model 'SourceRegionShape'
        db.create_table('source_shapes', (
            ('shape_area', self.gf('django.db.models.fields.FloatField')()),
            ('polygon', self.gf('django.db.models.fields.TextField')(max_length=10000000000)),
            ('shape_len', self.gf('django.db.models.fields.FloatField')()),
            ('source_region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.SourceRegion'], unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'source_data', ['SourceRegionShape'])

        # Deleting model 'SourceRegionPolygon'
        db.delete_table('source_region_polygons')
    ...
    models = {
        ...
        u'source_data.sourceregionpolygon': {
            'Meta': {'object_name': 'SourceRegionPolygon', 'db_table': "'source_region_polygons'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
