...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'source_data_document', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('docfile', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'source_data', ['Document'])

        # Adding field 'CsvUpload.document'
        db.add_column(u'source_data_csvupload', 'document',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'source_data_document')

        # Deleting field 'CsvUpload.document'
        db.delete_column(u'source_data_csvupload', 'document_id')
