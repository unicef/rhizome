...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'source_data_regionmap', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('master_region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Region'])),
            ('source_region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.SourceRegion'])),
            ('mapped_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'source_data', ['RegionMap'])

        # Adding model 'IndicatorMap'
        db.create_table(u'source_data_indicatormap', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('master_indicator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Indicator'])),
            ('source_indicator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.SourceIndicator'])),
            ('mapped_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'source_data', ['IndicatorMap'])

        # Adding model 'SourceIndicator'
        db.create_table(u'source_data_sourceindicator', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('mapped_status', self.gf('django.db.models.fields.CharField')(default='TO_MAP', max_length=55)),
        ))
        db.send_create_signal(u'source_data', ['SourceIndicator'])

        # Adding model 'CampaignMap'
        db.create_table(u'source_data_campaignmap', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('master_campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapoints.Campaign'])),
            ('source_campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.SourceCampaign'])),
            ('mapped_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'source_data', ['CampaignMap'])

        # Adding model 'SourceRegion'
        db.create_table(u'source_data_sourceregion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'source_data', ['SourceRegion'])

        # Adding model 'SourceCampaign'
        db.create_table(u'source_data_sourcecampaign', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'source_data', ['SourceCampaign'])


    def backwards(self, orm):
        # Deleting model 'RegionMap'
        db.delete_table(u'source_data_regionmap')

        # Deleting model 'IndicatorMap'
        db.delete_table(u'source_data_indicatormap')

        # Deleting model 'SourceIndicator'
        db.delete_table(u'source_data_sourceindicator')

        # Deleting model 'CampaignMap'
        db.delete_table(u'source_data_campaignmap')

        # Deleting model 'SourceRegion'
        db.delete_table(u'source_data_sourceregion')

        # Deleting model 'SourceCampaign'
        db.delete_table(u'source_data_sourcecampaign')
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 22, 0, 0)'}),
        ...
        u'source_data.campaignmap': {
            ...
            'source_campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.SourceCampaign']"})
        },
        ...
        u'source_data.indicatormap': {
            ...
            'source_indicator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.SourceIndicator']"})
        },
