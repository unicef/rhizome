...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'source_data_etljob', 'date_completed', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EtlJob.date_completed'
        raise RuntimeError("Cannot reverse this migration. 'EtlJob.date_completed' and its values cannot be restored.")
