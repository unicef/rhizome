...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CsvUpload', fields ['document', 'row_number', 'column_value']
        db.delete_unique(u'source_data_csvupload', ['document_id', 'row_number', 'column_value'])

        # Deleting model 'CsvUpload'
        db.delete_table(u'source_data_csvupload')

        # Adding model 'SourceDataPoint'
        db.create_table(u'source_data_sourcedatapoint', (
            ...
            ('cell_value', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('row_number', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.ProcessStatus'])),
            ('guid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 24, 0, 0))),
        ))
        db.send_create_signal('source_data', ['SourceDataPoint'])


    def backwards(self, orm):
        # Adding model 'CsvUpload'
        db.create_table(u'source_data_csvupload', (
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.ProcessStatus'])),
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=40, primary_key=True)),
            ('campaign_string', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('uniquesoc', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('region_string', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 23, 0, 0))),
            ('column_value', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('cell_value', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.Document'])),
            ('row_number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('source_data', ['CsvUpload'])

        # Adding unique constraint on 'CsvUpload', fields ['document', 'row_number', 'column_value']
        db.create_unique(u'source_data_csvupload', ['document_id', 'row_number', 'column_value'])

        # Deleting model 'SourceDataPoint'
        db.delete_table(u'source_data_sourcedatapoint')
