...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceDataPoint.region_code'
        db.add_column('source_datapoint', 'region_code',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceDataPoint.region_code'
        db.delete_column('source_datapoint', 'region_code')
