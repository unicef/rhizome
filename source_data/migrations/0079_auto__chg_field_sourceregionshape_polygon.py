...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceRegionShape.polygon'
        db.alter_column('source_shapes', 'polygon', self.gf('django.db.models.fields.TextField')(max_length=10000000000))

    def backwards(self, orm):

        # Changing field 'SourceRegionShape.polygon'
        db.alter_column('source_shapes', 'polygon', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'source_data.sourceregionshape': {
            'Meta': {'object_name': 'SourceRegionShape', 'db_table': "'source_shapes'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'polygon': ('django.db.models.fields.TextField', [], {'max_length': '10000000000'}),
