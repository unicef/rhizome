...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'region_map', 'source_id', 'source_object_id')
        db.rename_column(u'region_map', 'master_id', 'master_object_id')

        db.rename_column(u'indicator_map', 'source_id', 'source_object_id')
        db.rename_column(u'indicator_map', 'master_id', 'master_object_id')

        db.rename_column(u'campaign_map', 'source_id', 'source_object_id')
        db.rename_column(u'campaign_map', 'master_id', 'master_object_id')
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 30, 0, 0)'}),
        ...
        u'source_data.etljob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 30, 0, 0)'}),
