...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EtlJob.date_completed'
        db.add_column(u'source_data_etljob', 'date_completed',
                      self.gf('django.db.models.fields.DateField')(default='2014-01-01'),
                      keep_default=False)

        # Adding field 'EtlJob.task_name'
        db.add_column(u'source_data_etljob', 'task_name',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EtlJob.date_completed'
        db.delete_column(u'source_data_etljob', 'date_completed')

        # Deleting field 'EtlJob.task_name'
        db.delete_column(u'source_data_etljob', 'task_name')


    models = {
        u'source_data.etljob': {
            'Meta': {'object_name': 'EtlJob'},
            'date_attempted': ('django.db.models.fields.DateField', [], {}),
