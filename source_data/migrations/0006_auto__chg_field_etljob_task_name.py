...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EtlJob.task_name'
        db.alter_column(u'source_data_etljob', 'task_name', self.gf('django.db.models.fields.CharField')(max_length=55))

    def backwards(self, orm):

        # Changing field 'EtlJob.task_name'
        db.alter_column(u'source_data_etljob', 'task_name', self.gf('django.db.models.fields.CharField')(max_length=10))
