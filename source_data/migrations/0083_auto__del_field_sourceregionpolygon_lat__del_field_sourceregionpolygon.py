...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SourceRegionPolygon.lat'
        db.delete_column('source_region_polygon', 'lat')

        # Deleting field 'SourceRegionPolygon.lon'
        db.delete_column('source_region_polygon', 'lon')

        # Adding field 'SourceRegionPolygon.shape_len'
        db.add_column('source_region_polygon', 'shape_len',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)

        # Adding field 'SourceRegionPolygon.shape_area'
        db.add_column('source_region_polygon', 'shape_area',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)

        # Adding field 'SourceRegionPolygon.polygon'
        db.add_column('source_region_polygon', 'polygon',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

        # Adding unique constraint on 'SourceRegionPolygon', fields ['source_region']
        db.create_unique('source_region_polygon', ['source_region_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SourceRegionPolygon', fields ['source_region']
        db.delete_unique('source_region_polygon', ['source_region_id'])


        # User chose to not deal with backwards NULL issues for 'SourceRegionPolygon.lat'
        raise RuntimeError("Cannot reverse this migration. 'SourceRegionPolygon.lat' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceRegionPolygon.lat'
        db.add_column('source_region_polygon', 'lat',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'SourceRegionPolygon.lon'
        raise RuntimeError("Cannot reverse this migration. 'SourceRegionPolygon.lon' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceRegionPolygon.lon'
        db.add_column('source_region_polygon', 'lon',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'SourceRegionPolygon.shape_len'
        db.delete_column('source_region_polygon', 'shape_len')

        # Deleting field 'SourceRegionPolygon.shape_area'
        db.delete_column('source_region_polygon', 'shape_area')

        # Deleting field 'SourceRegionPolygon.polygon'
        db.delete_column('source_region_polygon', 'polygon')
