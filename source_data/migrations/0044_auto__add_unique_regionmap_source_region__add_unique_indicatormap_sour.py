...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'RegionMap', fields ['source_region']
        db.create_unique(u'source_data_regionmap', ['source_region_id'])

        # Adding unique constraint on 'IndicatorMap', fields ['source_indicator']
        db.create_unique(u'source_data_indicatormap', ['source_indicator_id'])
        ...
        # Adding unique constraint on 'CampaignMap', fields ['source_campaign']
        db.create_unique(u'source_data_campaignmap', ['source_campaign_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'CampaignMap', fields ['source_campaign']
        db.delete_unique(u'source_data_campaignmap', ['source_campaign_id'])
        ...
        # Removing unique constraint on 'IndicatorMap', fields ['source_indicator']
        db.delete_unique(u'source_data_indicatormap', ['source_indicator_id'])

        # Removing unique constraint on 'RegionMap', fields ['source_region']
        db.delete_unique(u'source_data_regionmap', ['source_region_id'])
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 23, 0, 0)'}),
        ...
        'source_data.csvupload': {
            'Meta': {'unique_together': "(('document', 'row_number', 'column_value'),)", 'object_name': 'CsvUpload'},
            ...
            'column_value': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 23, 0, 0)'}),
