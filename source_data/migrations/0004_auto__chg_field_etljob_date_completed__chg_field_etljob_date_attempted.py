...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EtlJob.date_completed'
        db.alter_column(u'source_data_etljob', 'date_completed', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'EtlJob.date_attempted'
        db.alter_column(u'source_data_etljob', 'date_attempted', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'EtlJob.date_completed'
        db.alter_column(u'source_data_etljob', 'date_completed', self.gf('django.db.models.fields.DateField')())

        # Changing field 'EtlJob.date_attempted'
        db.alter_column(u'source_data_etljob', 'date_attempted', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        u'source_data.etljob': {
            ...
            'task_name': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
