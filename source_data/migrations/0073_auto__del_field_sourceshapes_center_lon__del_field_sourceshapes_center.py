...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SourceShapes.center_lon'
        db.delete_column(u'source_data_sourceshapes', 'center_lon')

        # Deleting field 'SourceShapes.center_lat'
        db.delete_column(u'source_data_sourceshapes', 'center_lat')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SourceShapes.center_lon'
        raise RuntimeError("Cannot reverse this migration. 'SourceShapes.center_lon' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceShapes.center_lon'
        db.add_column(u'source_data_sourceshapes', 'center_lon',
                      self.gf('django.db.models.fields.FloatField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'SourceShapes.center_lat'
        raise RuntimeError("Cannot reverse this migration. 'SourceShapes.center_lat' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceShapes.center_lat'
        db.add_column(u'source_data_sourceshapes', 'center_lat',
                      self.gf('django.db.models.fields.FloatField')(),
                      keep_default=False)
    ...
    models = {
        ...
        u'source_data.sourceshapes': {
            'Meta': {'object_name': 'SourceShapes'},
            'geometry': ('jsonfield.fields.JSONField', [], {}),
            'global_id': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
