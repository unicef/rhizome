...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.created_by'
        db.add_column(u'source_data_document', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'CsvUpload.created_by'
        db.delete_column(u'source_data_csvupload', 'created_by_id')


    def backwards(self, orm):
        # Deleting field 'Document.created_by'
        db.delete_column(u'source_data_document', 'created_by_id')

        # Adding field 'CsvUpload.created_by'
        db.add_column(u'source_data_csvupload', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 19, 0, 0)'}),
