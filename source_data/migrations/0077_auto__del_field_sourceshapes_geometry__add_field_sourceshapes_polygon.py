...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SourceShapes.geometry'
        db.delete_column('source_shapes', 'geometry')

        # Adding field 'SourceShapes.polygon'
        db.add_column('source_shapes', 'polygon',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'SourceShapes.geometry'
        raise RuntimeError("Cannot reverse this migration. 'SourceShapes.geometry' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceShapes.geometry'
        db.add_column('source_shapes', 'geometry',
                      self.gf('jsonfield.fields.JSONField')(),
                      keep_default=False)

        # Deleting field 'SourceShapes.polygon'
        db.delete_column('source_shapes', 'polygon')
    ...
    models = {
        ...
        u'source_data.sourceshapes': {
            'Meta': {'object_name': 'SourceShapes', 'db_table': "'source_shapes'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
