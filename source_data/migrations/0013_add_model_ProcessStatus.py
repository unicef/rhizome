...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProcessStatus'
        db.create_table(u'source_data_processstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status_text', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('status_description', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'source_data', ['ProcessStatus'])


    def backwards(self, orm):
        # Deleting model 'ProcessStatus'
        db.delete_table(u'source_data_processstatus')
    ...
    models = {
        ...
        u'source_data.processstatus': {
            'Meta': {'object_name': 'ProcessStatus'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status_descriptoin': ('django.db.models.fields.CharField', [], {'max_length': '55'}),
            'status_text': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
