...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentDetail.db_model'
        db.add_column('document_detail', 'db_model',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding field 'DocumentDetail.master_object_id'
        db.add_column('document_detail', 'master_object_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentDetail.db_model'
        db.delete_column('document_detail', 'db_model')

        # Deleting field 'DocumentDetail.master_object_id'
        db.delete_column('document_detail', 'master_object_id')
