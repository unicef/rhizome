...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VCMBirthRecord.api_request_guid'
        db.add_column(u'source_data_vcmbirthrecord', 'api_request_guid',
                      self.gf('django.db.models.fields.CharField')(default='bla', max_length=255),
                      keep_default=False)

        # Adding field 'VCMSettlement.api_request_guid'
        db.add_column(u'source_data_vcmsettlement', 'api_request_guid',
                      self.gf('django.db.models.fields.CharField')(default='bla', max_length=255),
                      keep_default=False)

        # Adding field 'VCMSummaryNew.api_request_guid'
