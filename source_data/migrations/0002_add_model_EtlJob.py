...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EtlJob'
        db.create_table(u'source_data_etljob', (
            ('date_attempted', self.gf('django.db.models.fields.DateField')()),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=40, primary_key=True)),
        ))
        db.send_create_signal(u'source_data', ['EtlJob'])


    def backwards(self, orm):
        # Deleting model 'EtlJob'
        db.delete_table(u'source_data_etljob')
