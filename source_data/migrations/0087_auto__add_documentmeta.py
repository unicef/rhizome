...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'source_data_documentmeta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source_data.Document'])),
            ('string_to_map', self.gf('django.db.models.fields.CharField')(max_length=255)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'source_data_documentmeta')
    ...
    models = {
        ...
        u'source_data.documentmeta': {
            ...
            'string_to_map': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
