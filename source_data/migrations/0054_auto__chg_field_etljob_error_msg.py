...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EtlJob.error_msg'
        db.alter_column(u'source_data_etljob', 'error_msg', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EtlJob.error_msg'
        raise RuntimeError("Cannot reverse this migration. 'EtlJob.error_msg' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'EtlJob.error_msg'
        db.alter_column(u'source_data_etljob', 'error_msg', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 29, 0, 0)'}),
