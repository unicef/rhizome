...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SourceRegion.region_string'
        db.delete_column('source_region', 'region_string')


        # Changing field 'SourceRegion.region_code'
        db.alter_column('source_region', 'region_code', self.gf('django.db.models.fields.CharField')(default=1, unique=True, max_length=255))
        # Adding unique constraint on 'SourceRegion', fields ['region_code']
        db.create_unique('source_region', ['region_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'SourceRegion', fields ['region_code']
        db.delete_unique('source_region', ['region_code'])


        # User chose to not deal with backwards NULL issues for 'SourceRegion.region_string'
        raise RuntimeError("Cannot reverse this migration. 'SourceRegion.region_string' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceRegion.region_string'
        db.add_column('source_region', 'region_string',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)


        # Changing field 'SourceRegion.region_code'
        db.alter_column('source_region', 'region_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 2, 0, 0)'}),
