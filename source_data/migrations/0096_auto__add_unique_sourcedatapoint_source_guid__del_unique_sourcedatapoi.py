...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SourceDataPoint', fields ['source', 'source_guid', 'indicator_string']
        db.delete_unique('source_datapoint', ['source_id', 'source_guid', 'indicator_string'])

        # Adding unique constraint on 'SourceDataPoint', fields ['source_guid']
        db.create_unique('source_datapoint', ['source_guid'])


    def backwards(self, orm):
        # Removing unique constraint on 'SourceDataPoint', fields ['source_guid']
        db.delete_unique('source_datapoint', ['source_guid'])

        # Adding unique constraint on 'SourceDataPoint', fields ['source', 'source_guid', 'indicator_string']
        db.create_unique('source_datapoint', ['source_id', 'source_guid', 'indicator_string'])
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Source']"}),
            'source_guid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
