...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HeaderOverride'
        db.create_table(u'source_data_headeroverride', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('header_string', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 20, 0, 0))),
        ))
        db.send_create_signal(u'source_data', ['HeaderOverride'])
