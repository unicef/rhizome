...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SourceRegion.lat'
        db.add_column(u'source_data_sourceregion', 'lat',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding field 'SourceRegion.lon'
        db.add_column(u'source_data_sourceregion', 'lon',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SourceRegion.lat'
        db.delete_column(u'source_data_sourceregion', 'lat')

        # Deleting field 'SourceRegion.lon'
        db.delete_column(u'source_data_sourceregion', 'lon')
    ...
    models = {
        ...
        u'source_data.sourceregion': {
            ...
            'lon': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'region_string': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'settlement_code': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Source']"}),
            'source_guid': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
