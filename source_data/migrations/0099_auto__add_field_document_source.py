...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'source_data_document', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['datapoints.Source']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.source'
        db.delete_column(u'source_data_document', 'source_id')
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 6, 0, 0)'}),
