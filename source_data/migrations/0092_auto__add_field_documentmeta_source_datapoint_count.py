...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentMeta.source_datapoint_count'
        db.add_column('document_meta', 'source_datapoint_count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentMeta.source_datapoint_count'
        db.delete_column('document_meta', 'source_datapoint_count')
