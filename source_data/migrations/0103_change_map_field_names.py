...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('region_map', 'master_region_id', 'master_id')
        db.rename_column('region_map', 'source_region_id', 'source_id')

        db.rename_column('indicator_map', 'master_indicator_id', 'master_id')
        db.rename_column('indicator_map', 'source_indicator_id', 'source_id')

        db.rename_column('campaign_map', 'master_campaign_id', 'master_id')
        db.rename_column('campaign_map', 'source_campaign_id', 'source_id')
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 28, 0, 0)'}),
        ...
        u'source_data.campaignmap': {
            ...
            'master_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Campaign']"}),
            'source_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.SourceCampaign']", 'unique': 'True'})
        },
        ...
        u'source_data.etljob': {
            ...
            'date_attempted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 28, 0, 0)'}),
        ...
        u'source_data.indicatormap': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mapped_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'master_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Indicator']"}),
            'source_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.SourceIndicator']", 'unique': 'True'})
        },
        ...
        u'source_data.regionmap': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mapped_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'master_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['datapoints.Region']"}),
            'source_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['source_data.SourceRegion']", 'unique': 'True'})
        },
