...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActivityReport.meta_instanceID'
        db.delete_column(u'source_data_activityreport', 'meta_instanceID')

        # Adding field 'ActivityReport.meta_instanceid'
        db.add_column(u'source_data_activityreport', 'meta_instanceid',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ActivityReport.meta_instanceID'
        raise RuntimeError("Cannot reverse this migration. 'ActivityReport.meta_instanceID' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ActivityReport.meta_instanceID'
        db.add_column(u'source_data_activityreport', 'meta_instanceID',
    ...
    models = {
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 17, 0, 0)'}),
        ...
        'source_data.csvupload': {
            'Meta': {'unique_together': "(('document', 'row_number'),)", 'object_name': 'CsvUpload'},
