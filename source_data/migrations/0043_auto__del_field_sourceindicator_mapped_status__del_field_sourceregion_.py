...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'source_data_sourceindicator', 'mapped_status')

        # Deleting field 'SourceRegion.mapped_status'
        db.delete_column(u'source_data_sourceregion', 'mapped_status')

        # Deleting field 'SourceCampaign.mapped_status'
        db.delete_column(u'source_data_sourcecampaign', 'mapped_status')


    def backwards(self, orm):
        # Adding field 'SourceIndicator.mapped_status'
        db.add_column(u'source_data_sourceindicator', 'mapped_status',
                      self.gf('django.db.models.fields.CharField')(default='TO_MAP', max_length=55),
                      keep_default=False)

        # Adding field 'SourceRegion.mapped_status'
        db.add_column(u'source_data_sourceregion', 'mapped_status',
                      self.gf('django.db.models.fields.CharField')(default='TO_MAP', max_length=55),
                      keep_default=False)

        # Adding field 'SourceCampaign.mapped_status'
        db.add_column(u'source_data_sourcecampaign', 'mapped_status',
                      self.gf('django.db.models.fields.CharField')(default='TO_MAP', max_length=55),
                      keep_default=False)
