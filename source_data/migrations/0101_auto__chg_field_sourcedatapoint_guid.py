...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceDataPoint.guid'
        db.alter_column('source_datapoint', 'guid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'SourceDataPoint.guid'
        db.alter_column('source_datapoint', 'guid', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True))
