...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HeaderOverride.added_by'
        db.delete_column(u'source_data_headeroverride', 'added_by_id')

        # Adding field 'HeaderOverride.created_by'
        db.add_column(u'source_data_headeroverride', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HeaderOverride.added_by'
        db.add_column(u'source_data_headeroverride', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'HeaderOverride.created_by'
        db.delete_column(u'source_data_headeroverride', 'created_by_id')
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 20, 0, 0)'}),
