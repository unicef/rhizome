...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'source_data_sourcedatapoint', ['source_id', 'source_guid', 'indicator_string'])


    def backwards(self, orm):
        # Removing unique constraint on 'SourceDataPoint', fields ['source', 'source_guid', 'indicator_string']
        db.delete_unique(u'source_data_sourcedatapoint', ['source_id', 'source_guid', 'indicator_string'])
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 25, 0, 0)'}),
