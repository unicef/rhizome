...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceDataPoint.error_msg'
        db.add_column(u'source_data_sourcedatapoint', 'error_msg',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceDataPoint.error_msg'
        db.delete_column(u'source_data_sourcedatapoint', 'error_msg')
    ...
    models = {
        ...
        'source_data.sourcedatapoint': {
            ...
            'error_msg': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
