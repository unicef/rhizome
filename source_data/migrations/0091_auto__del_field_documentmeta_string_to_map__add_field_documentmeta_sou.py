...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DocumentMeta', fields ['document', 'string_to_map', 'model_type']
        db.delete_unique('document_meta', ['document_id', 'string_to_map', 'model_type'])

        # Deleting field 'DocumentMeta.string_to_map'
        db.delete_column('document_meta', 'string_to_map')

        # Adding field 'DocumentMeta.source_string'
        db.add_column('document_meta', 'source_string',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding unique constraint on 'DocumentMeta', fields ['document', 'source_string', 'model_type']
        db.create_unique('document_meta', ['document_id', 'source_string', 'model_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'DocumentMeta', fields ['document', 'source_string', 'model_type']
        db.delete_unique('document_meta', ['document_id', 'source_string', 'model_type'])


        # User chose to not deal with backwards NULL issues for 'DocumentMeta.string_to_map'
        raise RuntimeError("Cannot reverse this migration. 'DocumentMeta.string_to_map' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DocumentMeta.string_to_map'
        db.add_column('document_meta', 'string_to_map',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'DocumentMeta.source_string'
        db.delete_column('document_meta', 'source_string')

        # Adding unique constraint on 'DocumentMeta', fields ['document', 'string_to_map', 'model_type']
        db.create_unique('document_meta', ['document_id', 'string_to_map', 'model_type'])
    ...
    models = {
        ...
        'source_data.activityreport': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 12, 0, 0)'}),
