...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SourceDataPoint.region_string'
        db.delete_column('source_datapoint', 'region_string')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SourceDataPoint.region_string'
        raise RuntimeError("Cannot reverse this migration. 'SourceDataPoint.region_string' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SourceDataPoint.region_string'
        db.add_column('source_datapoint', 'region_string',
