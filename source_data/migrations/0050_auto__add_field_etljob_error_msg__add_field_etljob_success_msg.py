...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EtlJob.error_msg'
        db.add_column(u'source_data_etljob', 'error_msg',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding field 'EtlJob.success_msg'
        db.add_column(u'source_data_etljob', 'success_msg',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EtlJob.error_msg'
        db.delete_column(u'source_data_etljob', 'error_msg')

        # Deleting field 'EtlJob.success_msg'
        db.delete_column(u'source_data_etljob', 'success_msg')
