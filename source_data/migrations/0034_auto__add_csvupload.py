...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'source_data_csvupload', (
            ...
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 16, 0, 0))),
        ))
        db.send_create_signal(u'source_data', ['CsvUpload'])
