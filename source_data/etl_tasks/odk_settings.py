...
HEADER_DICT = {
    ...
    'New_VCM_Summary.csv' :['SubmissionDate', 'deviceid', 'simserial', 'phonenumber', 'DateOfReport', 'Date_Implement', 'SettlementCode', 'CensusNewBornsF', 'CensusNewBornsM', 'Tot_Newborns', 'Census2_11MoF', 'Census2_11MoM', 'Tot_2_11Months', 'Census12_59MoF', 'Census12_59MoM', 'Tot_12_59Months', 'Tot_Census', 'VaxNewBornsF', 'VaxNewBornsM',\
        ...
        'KEY'],
    'VWS_Register.csv': ['SubmissionDate', 'deviceid', 'simserial', 'phonenumber', 'DatePhoneCollected', 'FName_VWS', 'LName_VWS', 'WardCode', 'Personal_Phone', 'AcceptPhoneResponsibility', 'meta-instanceID', 'KEY'],
    'activity_report.csv': ['SubmissionDate', 'DateRecorded', 'start_time', 'endtime', 'SettlementGPS-Latitude', 'SettlementGPS-Longitude', 'SettlementGPS-Altitude', 'SettlementGPS-Accuracy', 'state', 'lga', 'ward', 'settlementname', 'title', 'names', 'activity', 'hc_townannouncer', 'hc_opvvaccinator', 'hc_recorder_opv', 'hc_separatetally', \
        ...
        'cm_attendance', 'cm_num_husband_issues', 'cm_num_caregiver_issues', 'cm_VCM_sett', 'cm_VCM_present', 'cm_iec', 'cm_num_vaccinated', 'cm_num_positive', 'ipds_team', 'ipds_issue_reported', 'ipds_other_issue', 'ipds_num_hh', 'ipds_num_children', 'ipds_issue_resolved', 'ipds_team_allowances', 'ipds_community_leader_present', 'meta-instanceID', 'KEY'],
    'VCM_Birth_Record.csv': ['SubmissionDate', 'deviceid', 'simserial', 'phonenumber', 'DateOfReport', 'DateReport', 'SettlementCode', 'HouseHoldNumber', 'DOB', 'NameOfChild', 'VCM0Dose', 'VCMRILink', 'VCMNameCAttended', 'meta-instanceID', 'KEY'],
    'Phone Inventory.csv': ['SubmissionDate', 'meta-instanceID', 'Name', 'State', 'LGA', 'Colour_phone', 'Asset_number', 'telephone_no', 'DeviceID', 'KEY'],
    'cluster_supervisor.csv': ['SubmissionDate', 'DateRecorded', 'start_time', 'end_time', 'instruction', 'supervision_location-Latitude', 'supervision_location-Longitude', 'supervision_location-Altitude', 'supervision_location-Accuracy', 'supervisor_title', 'supervisor_name', 'state', 'lga', 'supervisee_name', 'num_LGAC', 'hrop_endorsed', 'hrop_socialdata', 'hrop_special_pop', 'hrop_activities_planned', \
        'hrop_activities_conducted', 'hrop_implementation', 'hrop_workplan_aligned', 'coord_smwg_meetings', 'coord_vcm_meeting', 'coord_rfp_meeting', 'vcm_supervision', 'vcm_data', 'vcm_birthtracking', 'ri_supervision', 'fund_transparency', 'meta-instanceID', 'KEY'],
    'VCM_Summary.csv': ['SubmissionDate', 'deviceid', 'simserial', 'phonenumber', 'DateOfReport', 'Date_Implement', 'SettlementCode', 'CensusNewBornsF', 'CensusNewBornsM', 'Census2_11MoF', 'Census2_11MoM', 'Census12_59MoF', 'Census12_59MoM', 'VaxNewBornsF', 'VaxNewBornsM', 'Vax2_11MoF', 'Vax2_11MoM', 'Vax12_59MoF', 'Vax12_59MoM',\
        'Msd_grp_choice', 'group_msd_chd-Msd_PlaygroundF', 'group_msd_chd-Msd_PlaygroundM', 'group_msd_chd-Msd_SocEventF', 'group_msd_chd-Msd_SocEventM', 'group_msd_chd-Msd_MarketF', 'group_msd_chd-Msd_MarketM', 'group_msd_chd-Msd_FarmF', 'group_msd_chd-Msd_FarmM', 'group_msd_chd-Msd_SchoolF', 'group_msd_chd-Msd_SchoolM', 'group_msd_chd-Msd_ChildSickF', 'group_msd_chd-Msd_ChildSickM', 'group_msd_chd-Msd_SideEffectsF', 'group_msd_chd-Msd_SideEffectsM', 'group_msd_chd-Msd_NoFeltNeedF', 'group_msd_chd-Msd_NoFeltNeedM', 'group_msd_chd-Msd_TooManyRoundsF', 'group_msd_chd-Msd_TooManyRoundsM', 'group_msd_chd-Msd_RelBeliefsF', \
        'group_msd_chd-Msd_RelBeliefsM', 'group_msd_chd-Msd_PolDiffsF', 'group_msd_chd-Msd_PolDiffsM', 'group_msd_chd-Msd_UnhappyWTeamF', 'group_msd_chd-Msd_UnhappyWTeamM', 'group_msd_chd-Msd_NoPlusesF', 'group_msd_chd-Msd_NoPlusesM', 'group_msd_chd-Msd_NoGovtServicesF', 'group_msd_chd-Msd_NoGovtServicesM', 'group_msd_chd-Msd_PolioUncommonF', 'group_msd_chd-Msd_PolioUncommonM', 'group_msd_chd-Msd_PolioHasCureF', 'group_msd_chd-Msd_PolioHasCureM', 'group_msd_chd-Msd_OtherProtectionF', 'group_msd_chd-Msd_OtherProtectionM', 'group_msd_chd-Msd_NoConsentF', 'group_msd_chd-Msd_NoConsentM', 'group_msd_chd-Msd_HHNotVisitedF', 'group_msd_chd-Msd_HHNotVisitedM', 'group_msd_chd-Msd_NoReasonF', \
        'group_msd_chd-Msd_NoReasonM', 'group_msd_chd-Msd_SecurityF', 'group_msd_chd-Msd_SecurityM', 'group_msd_chd-Msd_AgedOutF', 'group_msd_chd-Msd_AgedOutM', 'group_msd_chd-Msd_FamilyMovedF', 'group_msd_chd-Msd_FamilyMovedM', 'group_msd_chd-Msd_ChildDiedF', 'group_msd_chd-Msd_ChildDiedM', 'spec_grp_choice', 'group_spec_events-Spec_ZeroDose', 'group_spec_events-Spec_PregnantMother', 'group_spec_events-Spec_Newborn', 'group_spec_events-Spec_VCMAttendedNCer', 'group_spec_events-Spec_CMAMReferral', 'group_spec_events-Spec_RIReferral', 'group_spec_events-Spec_AFPCase', 'group_spec_events-Spec_MslsCase', 'group_spec_events-Spec_OtherDisease', 'group_spec_events-Spec_FIC', \
        'meta-instanceID', 'KEY']
}
