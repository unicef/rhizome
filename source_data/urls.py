...
urlpatterns = [
    ...
    url(r'^document_review/(?P<document_id>[0-9]+)/$', document_review, name='document_review'),
    url(r'^sync_source_datapoints/(?P<document_id>[0-9]+)/(?P<master_indicator_id>[0-9]+)/$', \
        sync_source_datapoints, name='sync_source_datapoints'),
