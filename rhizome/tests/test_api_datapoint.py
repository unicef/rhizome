...
class DataPointResourceTest(RhizomeAPITestCase):
    ...
    def test_get_list(self):
        ...
        document = Document.objects.create(
            doc_title='I am Every Woman -- Whitney Houston')
    ...
    def test_get_no_params(self):
        ...
        self.assertEqual(response_data['error'][
                         0], "\"'indicator__in'\" is a required parameter!")
    ...
    def test_indicator_filter(self):
        ...
        some_provinces = ['Kandahar', 'Kunar', 'Hilmand',
                          'Nimroz', 'Sari-Pul', 'Kabul', 'Paktika', 'Ghazni']

        ind_id_keys = indicator_ids_to_values.keys()
        indicator_to_query = ind_id_keys[1]

       # choose which indicator/value pair to filter by, and keep track of dps
       # that match this as they're created
        indicator_to_filter = ind_id_keys[0]
        indicator_val_to_filter = indicator_ids_to_values[
            indicator_to_filter][0]
        dps_to_track = []
        ...
        indicator_name_to_filter = Indicator.objects.get(
            id=indicator_to_filter)
    ...
    def _get_cumulative(self):  # handling cumulative differntly
        ...
        self.assertEqual(returned_indicators[0]['indicators'][
                         0]['value'], value_1 + value_2)
    ...
    def test_location_type_and_depth(self):
        ...
        # makes sure we're getting the right dp values, thus confirming that
        # the provinces are returned
        sum_of_values = 0
